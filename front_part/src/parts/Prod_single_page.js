...
import './Prod_card'
import {Button, Image,  Row, Col, Form,ListGroup} from 'react-bootstrap'
...
const Prod_single_page = ({ history, match }) => {
    ...
    const {
        success: successCapsuleComm,
        broadcast: broadcastCapsuleComm,
        error: errorCapsuleComm,
    } = capsuleComm
                ...
                <Col md={7}>
                     {capsule?(<div>
                        <div className="subtitle">
                         ...
                         <Image className='w-35' src={capsule.picture} alt={capsule.name}></Image>
                ...
                <Col md={5} className="clr__background">
                    ...
                    <ListGroup variant='flush' className="clr__background">
                        ...
                        {capsule.comms.map((co) => (
                            <ListGroup.Item  className="clr__background" key={co._id}>
